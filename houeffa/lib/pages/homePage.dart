          ...
          Expanded(
            child: StreamBuilder<List<Logement>>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.isEmpty) {
                  return Center(child: Text('Aucun logement trouvé', style: TextStyle(color: Colors.grey[600])));
                }
    ...
    return Card(
      ...
      child: ClipRRect(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            logement.images != null && logement.images!.isNotEmpty
                ? Image.asset(logement.images!.first, height: 200, fit: BoxFit.cover)
                : Container(
                    height: 200,
                    color: Colors.grey[300],
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.location_on, color: Colors.grey, size: 16),
                      SizedBox(width: 4),
                      Text(logement.adresse, style: TextStyle(color: Colors.grey)),
                    ],
                  ),
                  SizedBox(height: 8),
                  Text(
